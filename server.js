...
async function handleAPI(req, res, url) {
  ...
  try {
    ...
    if (url === '/api/generate-report' && req.method === 'POST') {
      ...
      await pool.query(
        'INSERT INTO reports (id, consultancy_id, title, report_type, content, files_used, custom_instructions, target_persona_id, previous_report_id) VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9)',
        [reportId, consultancyId, finalTitle, reportType || 'diagnostico_completo', clean, JSON.stringify(fileIds || []), customInstructions || null, targetPersonaId || null, previousReportId || null]
      );
